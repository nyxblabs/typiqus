...
import type { FunctionArg, JSType, Schema, TypeDescriptor } from '../types'
import {
   cachedFn,
   getTypeDescriptor,
   mergedTypes,
...
const babelPluginTypiqus: PluginItem = function (
   api: ConfigAPI,
...
export default babelPluginTypiqus
